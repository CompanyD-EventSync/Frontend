...
export default function RegisterPurchaserPage() {
  return (
    <div className="flex h-screen">
      <div className="w-1/2 bg-white flex flex-col items-center justify-center">
        ...
        <p className="mt-4 text-sm text-gray-700 uppercase tracking-widest">Join Events Easily & Instantly</p>
      ...
      <div className="w-1/2 bg-purple-100 flex items-center justify-center">
        <div className="w-3/4 max-w-md bg-white bg-opacity-50 rounded-xl p-6">
          <div className="flex mb-4">
            <Link to="/register-organizer" className="flex-1 bg-purple-300 text-center py-2 rounded-l-xl">Event Organizer</Link>
            <button className="flex-1 bg-purple-700 text-white py-2 rounded-r-xl">Purchaser</button>
          </div>
